...
const mcp3204 = function(pi, spi, mcpChannel) {
  ...
  //   Bit 0: 0 not used in MCP3204
  //            (would be used in MCP3208 to allow more channels)
  // Byte 1:
  ...
  pigpiod.spi_xfer(pi, spi, txBuf, rxBuf, 3);
